...
**IMPORTANT**: This file (`aiq-ralph/CLAUDE.md`) must stay in sync with the installed copy at `~/.claude/CLAUDE.md`.

**Whenever this file is updated**:
1. Copy changes to `~/.claude/CLAUDE.md` (or run `./install.sh`)
2. Commit the change to this project (aiq-ralph)
3. This ensures company AI coding guidelines are tracked in version control

**Why**: This project serves as the canonical, version-controlled source for company-wide AI coding guidelines that get installed to `~/.claude/CLAUDE.md`.
